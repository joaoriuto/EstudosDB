...
ALTER TABLE PRODUTO
CHANGE PRECO VALOR_UNIT INT NOT NULL; --> PERMITE MODIFICAR NOME, TIPO E CLAUSULA
...
ALTER TABLE PRODUTO
MODIFY VALOR_UNIT VARCHAR(50) NOT NULL;
...
| VALOR_UNIT   | varchar(50) | NO   |     | NULL    |                |
| FRETE        | float(10,2) | NO   |     | NULL    |                |
+--------------+-------------+------+-----+---------+----------------+

--> ADICIONANDO EM PRIMEIRA POSIÇÃO
